...
namespace EmailClient
{
    public partial class MainForm : Form
    {
        ...
        {
            // Khởi tạo bất kỳ cái gì cần thiết khi form load, nếu cần
        }
        ...
        private void lvEmails_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                var message = (MimeMessage)lvEmails.SelectedItems[0].Tag;
                var emailDetailForm = new EmailDetailForm(message);
